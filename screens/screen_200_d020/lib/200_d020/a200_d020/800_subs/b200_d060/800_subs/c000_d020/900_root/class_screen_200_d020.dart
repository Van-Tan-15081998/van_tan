...
/// -----
class CoreTextBindingComponent extends TextComponent with ExecutionCore, CoreComponent, CoreState {
  /// -----
  /// TODO: Constructor
  /// -----
  CoreTextBindingComponent({
  ...
  void onSetText({required String? value, bool? caiDatUuTien}) {
