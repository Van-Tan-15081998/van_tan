...
/// -----
/// TODO: CoreAnchor - [Cấu Trúc] Điểm Neo
/// -----
class CoreAnchor extends CoreObject {
  /// -----
  /// TODO: Attach Root
  /// -----
  @override
  ...
  /// -----
  String? _anchorValue;
  String? get onGetAnchorValue => _anchorValue;
  Future<void> onSetAnchorValue({required String? value, bool? isPriorityOverride}) async {
