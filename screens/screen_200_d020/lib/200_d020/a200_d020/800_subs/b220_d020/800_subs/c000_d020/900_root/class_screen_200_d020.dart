...
/// -----
class CoreCompositeBindingComponent extends PositionComponent with ExecutionCore, CoreComponent, CoreState {
  /// -----
  /// TODO: Constructor
  /// -----
  CoreCompositeBindingComponent({
  ...
  /// TODO:
  /// -----
  CoreTextBindingComponent? _textBindingComponent;
  CoreTextBindingComponent? get getTextBindingComponent => _textBindingComponent;
  Future<void> onSetTextBindingComponent({required CoreTextBindingComponent? value, bool? caiDatUuTien}) async {
    if (caiDatUuTien == true) {
      _textBindingComponent = value;
    } else {
      _textBindingComponent ??= value;
    }
