...
/// -----
/// TODO: CoreFrameRate - [Cấu Trúc] Tốc Độ Khung Hình Khung Hình
/// -----
class CoreFrameRate with ExecutionCore {
  /// -----
  /// TODO: Attach Root
  /// -----
  @override
  ...
  /// -----
  /// TODO: Giá Trị Tốc Độ Khung Hình
  /// -----
  int? _fpsValue;
  int? get onGetFpsValue => _fpsValue;
  Future<void> onSetFpsValue({required int? value, bool? isPriorityOverride}) async {
