...
/// -----
/// TODO: CoreStateManagement - [Cấu Trúc] Quản Lý Trạng Thái
/// -----
abstract class CoreStateManagement with ExecutionCore {
  /// -----
  /// TODO: Attach Root
  /// -----
  @override
  ...
  Future<void> onSetParent({required CoreStateManagement? value, bool? isPriorityOverride}) async {
  ...
  /// TODO:
  /// -----
  T? getParentAs<T extends CoreStateManagement>() {
    if (_parent is T) {
      return _parent as T;
    }
    return null;
