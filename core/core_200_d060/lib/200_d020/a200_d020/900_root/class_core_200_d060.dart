...
/// -----
/// TODO: CoreObject - [Cấu Trúc] Đối Tượng Core
/// -----
abstract class CoreObject with ExecutionCore {
  /// -----
  /// TODO: Attach Root
  /// -----
  @override
  ...
  /// -----
  CoreObject? _parent;
  CoreObject? get getParent => _parent;
  Future<void> onSetParent({required CoreObject? value, bool? isPriorityOverride}) async {
  ...
  /// TODO:
  /// -----
  T? getParentAs<T extends CoreObject>() {
    if (_parent is T) {
      return _parent as T;
    }
    return null;
  ...
  /// -----
  /// TODO: Sử Dụng getParentAs
  /// ----- CoreAnchor anchor = CoreAnchor();
  /// ----- anchor.onSetParent(value: CoreAnchor2());
  /// -----
  /// ----- CoreAnchor2 parent = anchor.getParentAs<CoreAnchor2>()
  /// -----
}
